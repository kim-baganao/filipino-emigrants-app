...
export default function MLPForecast({ data, maleData, femaleData }) {
  ...
  const handleForecast = async () => {
    ...
    try {
      ...
      // Use most recent historical male/female ratio across all forecast steps
      ...
      for (let i = 0; i < yearsToForecast; i++) {
        ...
        predictions.push({
          year: currentYear,
          male: Math.round(predictedTotal * maleRatio),
          female: Math.round(predictedTotal * femaleRatio),
      ...
      alert(`Generated ${yearsToForecast} year MLP forecast!`);
    } catch (error) {
      ...
      {forecasts.length > 0 && (
        <>
          ...
          <div className="forecast-results">
            <h3>MLP Forecast Results (Male, Female, Total)</h3>
            <table>
              <thead>
                <tr>
                  <th>Year</th>
